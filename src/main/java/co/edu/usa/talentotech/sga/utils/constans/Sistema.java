...
public class Sistema {
     ...
     */
    public static final String NOMBRE_SISTEMA = "Tienda";
     ...
     */
    public static final Integer POSICION_TOKEN = 7;
	 ...
	 */
	public static final String HEADER_USUARIO = "username";

	/**
	 * Cabecera para la contraseña.
	 */
	public static final String HEADER_CONTRASENA = "password";

	/**
	 * Cabecera para el tipo de contenido.
	 */
	public static final String HEADER_TIPO_CONTENIDO = "Content-Type";
	 ...
	 */
	public static final String VALOR_HEADER_TIPO_CONTENIDO = "application/json; charset=UTF-8";
	
    /**
     * Valor del tipo de contenido JSON.
     */
	public static final String VALOR_HEADER_TIPO_CONTENIDO_JSON = "application/json";

    /**
	 * Formato de fecha "YYYY-MM-DD"
	 */	
	public static final String FORMATO_SENCILLO_FECHA="YYYY-MM-DD";
     ...
     */
    public static final String ESTADO_USUARIO = "estadoUsuario";
     ...
     */
    public static final String ESTADO_PRODUCTO = "estadoProducto";

    /**
     * Constante para el estado venta
     */
    public static final String ESTADO_VENTA = "estadoVenta";
     ...
     * Constante para el estado de usuario
     */
    public static final Long ID_ESTADO_USUARIO_INACTIVO = 2L;

    /**
     * Constante para el estado de usuario
     */
    public static final Long ID_ROL_USUARIO = 2L;

    /**
     * Constante para CODIFICACION_ISO8859
     */
    public static String CODIFICACION_ISO8859 = "iso-8859-1";
    ...
    public static int TAMANO_CONTRASENA = 8;
}
